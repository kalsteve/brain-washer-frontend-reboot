...
const Play: React.FC = () => {
    ...
    return (
        ...
        >
            <div className="absolute top-0 left-0 flex flex-col items-start px-[10%]">
            ...
            {content && (
                <div className="mt-5 text-center max-w-[70rem] mx-auto p-8 bg-white bg-opacity-10 rounded-2xl shadow-lg">
